...
const General=({category})=>{
    ...
    useEffect(()=>{
        axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=${category}&apiKey=5fb6029180784c218cae228a28e16068`)
            ...
            <div className="row"> 
           {
            News?News.map((val)=>{
               ...
               <div className="col-sm-12 col-md-4 col-lg-3 mt-1 p-1" style={{height:"500px",width:"400px"}}>
                     <div className="card p-2 rounded bg-light text-dark border-1" >
